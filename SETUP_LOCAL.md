...
> The complete switch reference (including the in-process MLX / TTS-sidecar / transcription-provider knobs) lives in [`docs/development/info-plist-switches.md`](docs/development/info-plist-switches.md). The table below covers the core local-mode knobs.
