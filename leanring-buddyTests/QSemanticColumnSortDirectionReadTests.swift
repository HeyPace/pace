...
struct QSemanticColumnSortDirectionReadTests {
    ...
    func capabilityRegistrationAcceptsUIReadColumnSortDirection() throws {
        ...
        // 72 (Phase 2BU's ui.read_table_dimensions, Phase 2BV's ui.read_element_allowed_values,
        // Phase 2BW's ui.read_element_value_description, then Phase 2BX's
        // ui.list_label_served_elements), so this checks the current total rather than a
        // phase-specific snapshot.
        #expect(QModelPlanParser.registeredCapabilities.count == 72)
