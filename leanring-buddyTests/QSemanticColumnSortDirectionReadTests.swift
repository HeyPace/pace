...
struct QSemanticColumnSortDirectionReadTests {
    ...
    func capabilityRegistrationAcceptsUIReadColumnSortDirection() throws {
        ...
        // 76 (Phase 2BU's ui.read_table_dimensions, Phase 2BV's ui.read_element_allowed_values,
        ...
        // 2BZ's ui.list_table_row_headers, Phase 2CA's ui.read_scroll_position, then Phase 2CB's
