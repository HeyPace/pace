...
struct QSemanticElementExpandedStateReadTests {
    ...
    @Test("25b. Capability count integrity: 78 → 79 is the only registry-size delta attributable to this phase — structural, confirmed by the registration test's own == 79 assertion above")
