...
struct QSemanticElementIndexReadTests {
    ...
    @Test("35. Capability count integrity: 82 → 83 was this phase's own registry-size delta — structural, confirmed by the registration test's own count assertion above")
