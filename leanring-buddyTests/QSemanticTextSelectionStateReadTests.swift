...
struct QSemanticTextSelectionStateReadTests {
    ...
    func capabilityRegistrationAcceptsUIReadTextSelectionState() throws {
        ...
        // 76 (Phase 2BT's ui.read_column_sort_direction, Phase 2BU's ui.read_table_dimensions,
        ...
        // 2CA's ui.read_scroll_position, then Phase 2CB's ui.read_element_role_description), so
