...
struct QSemanticTextSelectionStateReadTests {
    ...
    func capabilityRegistrationAcceptsUIReadTextSelectionState() throws {
        ...
        // 75 (Phase 2BT's ui.read_column_sort_direction, Phase 2BU's ui.read_table_dimensions,
        ...
        // 2BY's ui.read_window_auxiliary_buttons, Phase 2BZ's ui.list_table_row_headers, then
        // Phase 2CA's ui.read_scroll_position), so this checks the current total rather than a
