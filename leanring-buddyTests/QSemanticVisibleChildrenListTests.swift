...
struct QSemanticVisibleChildrenListTests {
    ...
    @Test("43. Capability count integrity: 81 → 82 was this phase's own registry-size delta — structural, confirmed by the registration test's own count assertion above")
